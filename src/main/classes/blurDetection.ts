 ...
 */
export default class BlurDetection {
   ...
   */
  static applyVerticalEdgeDetection(imageData: Uint8ClampedArray, width: number, height: number): Uint8ClampedArray {
    return Spatial.applyFilter(imageData, width, height, "Vertical Edge");
  }
   ...
   */
  static applyHorizontalEdgeDetection(imageData: Uint8ClampedArray, width: number, height: number): Uint8ClampedArray {
    return Spatial.applyFilter(imageData, width, height, "Horizontal Edge");
  }
   ...
   */
  static applyBothFilters(imageData: Uint8ClampedArray, width: number, height: number): Uint8ClampedArray {
   ...
   */
  private static combineResultsIntoMagnitude(
    verticalResult: Uint8ClampedArray, 
    horizontalResult: Uint8ClampedArray, 
    width: number, 
    height: number
  ): Uint8ClampedArray {
   ...
   */
  static detectBlur(imageData: Uint8ClampedArray, width: number, height: number): Uint8ClampedArray {
