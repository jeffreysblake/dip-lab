...
class Spatial {
     ...
     */
    static applyFilter(imageData, width, height, kernelName) {
        var _a, _b, _c;
                ...
                for (let ky = 0; ky < kernelSize; ky++) {
                    for (let kx = 0; kx < kernelSize; kx++) {
                        ...
                        if (px >= 0 && px < width && py >= 0 && py < height) {
                            ...
                            const r = (_a = imageData[index]) !== null && _a !== void 0 ? _a : 0;
                            const g = (_b = imageData[index + 1]) !== null && _b !== void 0 ? _b : 0;
                            const b = (_c = imageData[index + 2]) !== null && _c !== void 0 ? _c : 0;
